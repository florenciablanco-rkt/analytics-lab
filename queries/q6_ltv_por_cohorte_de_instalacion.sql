-- Q6 — LTV por cohorte de instalación
-- Revenue acumulado a 30 y 60 días desde el install, agrupado por mes de
-- cohorte. Muestra cuánto vale en el tiempo cada grupo de usuarios según
-- cuándo instalaron. Ventana sugerida: 180 días (~3 cohortes mensuales).
WITH installs AS (
    SELECT
        app_id,
        mmp_device_id,
